...
from ultimate_rvc.core.generate.song_cover import convert as _convert_voice
from ultimate_rvc.core.generate.song_cover import wavify as _wavify
    ...
    accepted_format: Annotated[
        ...
        typer.Option(
            ...
            help=(
                ...
                " default accepted formats are mp3, ogg, flac, m4a and aac. See the"
                " --accepted-formats option for more information on accepted formats"
            ),
        ),
    ] = None,
) -> None:
...
def convert_voice(
    ...
    rprint()
    rprint("[~] Converting voice track using RVC...")
    converted_vocals_path = _convert_voice(
    ...
    rprint()
    rprint("Elapsed time:", format_duration(time.perf_counter() - start_time))
    rprint(Panel(f"[green]{converted_vocals_path}", title="Converted Voice Path"))
