...
def load_embedding(embedder_model, custom_embedder=None):
    ...
    online_embedders = {
        ...
        "spin-v2": (
            "https://huggingface.co/IAHispano/Applio/resolve/main/Resources/embedders/spin-v2/pytorch_model.bin"
        ),
        "chinese-hubert-base": (
            "https://huggingface.co/IAHispano/Applio/resolve/main/Resources/embedders/chinese_hubert_base/pytorch_model.bin"
        ),
    ...
    config_files = {
        ...
        "spin-v2": (
            "https://huggingface.co/IAHispano/Applio/resolve/main/Resources/embedders/spin-v2/config.json"
        ),
        "chinese-hubert-base": (
