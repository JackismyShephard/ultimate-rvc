...
from ultimate_rvc.web.typing_extra import ManageModelEventState

if TYPE_CHECKING:

    from ultimate_rvc.web.typing_extra import ManageModelConfig, TotalConfig
...
def render(total_config: TotalConfig) -> None:
    ...
    _render_delete_tab(total_config, event_state)
    ...
    *_, all_model_update = [
        click_event.success(
            ...
            outputs=[
                ...
                tab_config.voice_models.instance,
            ],
    ...
    *_, all_model_update = [
        click_event.success(
            ...
            outputs=[
                total_config.song.one_click.embedder_model.instance,
                total_config.song.multi_step.embedder_model.instance,
                total_config.speech.one_click.embedder_model.instance,
                total_config.speech.multi_step.embedder_model.instance,
                total_config.training.multi_step.embedder_model.instance,
    ...
    *_, all_model_update = [
        click_event.success(
            ...
            outputs=[
                ...
                tab_config.pretrained_models.instance,
            ],
            show_progress="hidden",
        )
        for click_event in [
    ...
    for click_event in [
        ...
        click_event.success(
            ...
            outputs=[
                ...
                tab_config.training_models.instance,
            ],
            show_progress="hidden",
        )
    ...
    with gr.Tab("Upload models"):
        ...
        with gr.Accordion("Custom embedder models", open=False):
            ...
            with gr.Row(equal_height=True):
                ...
                event_state.upload_voice_click.instance = upload_embedder_btn.click(
...
def _render_delete_tab(
    ...
    with gr.Tab("Delete models"):
        _render_voice_model_accordion(tab_config, event_state)
        _render_embedder_model_accordion(tab_config, event_state)
        _render_pretrained_model_accordion(tab_config, event_state)
        _render_training_model_accordion(tab_config, event_state)
        _render_all_model_accordion(tab_config, event_state)


def _render_voice_model_accordion(
    tab_config: ManageModelConfig,
    event_state: ManageModelEventState,
) -> None:
    with gr.Accordion("Voice models", open=False), gr.Row():
        with gr.Column():
            tab_config.voice_models.instance.render()
    ...
    event_state.delete_voice_click.instance = setup_delete_event(
        delete_voice_btn,
        delete_voice_models,
        [tab_config.dummy_checkbox.instance, tab_config.voice_models.instance],
        delete_voice_msg,
...
def _render_embedder_model_accordion(
    tab_config: ManageModelConfig,
    event_state: ManageModelEventState,
) -> None:
...
def _render_pretrained_model_accordion(
    tab_config: ManageModelConfig,
    event_state: ManageModelEventState,
) -> None:
    with gr.Accordion("Custom pretrained models", open=False), gr.Row():
        with gr.Column():
            tab_config.pretrained_models.instance.render()
    ...
    event_state.delete_pretrained_click.instance = setup_delete_event(
        ...
        delete_custom_pretrained_models,
        [tab_config.dummy_checkbox.instance, tab_config.pretrained_models.instance],
...
def _render_training_model_accordion(
    tab_config: ManageModelConfig,
    event_state: ManageModelEventState,
) -> None:
    ...
    with gr.Accordion("Training models", open=False), gr.Row():
        with gr.Column():
            tab_config.training_models.instance.render()
    ...
    event_state.delete_trained_click.instance = setup_delete_event(
        delete_train_btn,
        delete_training_models,
        [tab_config.dummy_checkbox.instance, tab_config.training_models.instance],
        delete_train_msg,
...
def _render_all_model_accordion(
    tab_config: ManageModelConfig,
    event_state: ManageModelEventState,
) -> None:
